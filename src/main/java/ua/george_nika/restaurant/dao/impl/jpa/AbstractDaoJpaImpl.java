...
import ua.george_nika.restaurant.dao.util.MySortDirection;
import ua.george_nika.restaurant.dao.util.SortAndRestrictForEntity;
import ua.george_nika.restaurant.errors.WorkWithDataBaseRuntimeException;
...
abstract public class AbstractDaoJpaImpl<T> implements AbstractDao<T> {
    ...
    public void save(Object abstractEntity) {
        try {
            ...
            RestaurantLogger.warn(LOGGER_NAME, "save exception " + abstractEntity.toString());
    ...
    public void update(Object abstractEntity) {
        try {
            ...
            RestaurantLogger.warn(LOGGER_NAME, "update exception " + abstractEntity.toString());
    ...
    public void delete(Object abstractEntity) {
        try {
            ...
            RestaurantLogger.warn(LOGGER_NAME, "delete exception " + abstractEntity.toString());
    ...
    public T getById(Integer id) {
        ...
        try {
            ...
            RestaurantLogger.warn(LOGGER_NAME, "can't find " + getEntityClass() + " with id " + id);
    ...
    public List<T> getAll() {
        ...
        try {
            ...
            RestaurantLogger.warn(LOGGER_NAME, "can't find all " + getEntityClass());
            throw new WorkWithDataBaseRuntimeException("can`t obtain result from database");
        }
    ...
    public T getSingleBy(String field, String value) {
        ...
        try {
            ...
            RestaurantLogger.warn(LOGGER_NAME, "can't find single " + getEntityClass() + " - field: " + field
                    + " value: " + value);
            throw new WorkWithDataBaseRuntimeException("can`t obtain result from database");
        }
        return result;
    ...
    public T getSingleByObject(String field, Object value) {
        T result;
        try {
            Query query = entityManager.createQuery
                    ("SELECT t FROM " + getEntityClass().getName() + " t WHERE t." + field + " = :param1");
    ...
    public List<T> getListByObject(String field, Object value) {
        List<T> result;
        try {
            Query query = entityManager.createQuery
                    ("SELECT t FROM " + getEntityClass().getName() + " t WHERE t." + field + " = :param1");
            ...
            RestaurantLogger.warn(LOGGER_NAME, "can't find list " + getEntityClass() + " - field: " + field
                    + " value: " + value);
            throw new WorkWithDataBaseRuntimeException("can`t obtain result from database");
        }
        return result;
    ...
    public int getCountRecordsWith(String field, String value) {
        ...
        try {
            ...
            RestaurantLogger.warn(LOGGER_NAME, "can't obtain counts  " + getEntityClass() + " - field: " + field
                    + " value: " + value);
            throw new WorkWithDataBaseRuntimeException("can`t obtain result from database");
        }
    ...
    (Integer offset, Integer limit, SortAndRestrictForEntity sortAndRestrict) {
        ...
        try {
            ...
            RestaurantLogger.warn(LOGGER_NAME, "can't obtain filtered and sorted list " + getEntityClass()
    ...
    public int getCountRecordsFilteredAndSortedList (SortAndRestrictForEntity sortAndRestrict) {
        ...
        try {
            ...
            RestaurantLogger.warn(LOGGER_NAME, "can't obtain count records filtered and sorted list " + getEntityClass()
